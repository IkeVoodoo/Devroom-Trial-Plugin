...
public class RegionRemoveCommand implements TabExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (!whitelist.contains(id)) {
            sender.sendMessage("§aGood news! That player is not in the whitelist!");
            return true;
        }
        ...
        sender.sendMessage("§aSuccessfully removed player '§3%s§a' from whitelist in '§6%s§a'".formatted(
